    ...
    private function getCategoryData($category)
    {
        $categories = [
            'clothing' => [
                ...
                'subcategories' => ['Шорты', 'Штаны', 'Джинсы', 'Брюки', 'Футболки', 'Майки', 'Поло', 'Лонгсливы', 'Джемпер', 'Свитер', 'Свитшот', 'Кардиган', 'Худи', 'Зип-худи', 'Рубашки', 'Кофты', 'Платья', 'Блузки', 'Костюмы', 'Бомберы', 'Куртки', 'Ветровки', 'Пиджаки', 'Пуховики', 'Жилетки', 'Пальто']
            ],
            'shoes' => [
                'name' => 'Обувь',
                'title' => 'Обувь',
